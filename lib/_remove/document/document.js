function ItemDocument(base, graph) {
    ...
    Object.defineProperty(base, 'document', {
        'get': Delegate(this, function () {
            return this;
        })
    });

    Object.defineProperty(graph, 'draftData', {
        'get': function () {
            if (draft.count) return draft.values;
        }
    });
    Object.defineProperty(graph, 'storedData', {
        'get': function () {
            if (stored.count) return stored.values;
        }
    });
    ...
    graph.discardMemoryChanges = Delegate(this, function () {
        this.discardMemoryChanges();
    });
