function ItemProxy(item, id, session) {
    ...
    Object.defineProperty(item, 'removing', {
        'get': function () {
            return base.removing;
        }
    });

    Object.defineProperty(item, 'isUnpublished', {
        'get': function () {
            return base.data.isUnpublished;
        }
    });
    Object.defineProperty(item, 'unpublished', {
        'get': function () {
            return base.data.unpublished;
        }
    });
