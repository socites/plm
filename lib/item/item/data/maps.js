function ItemMaps(proxy, item, data) {
    ...
    let maps = new Map();
    Object.defineProperty(this, 'keys', {'get': () => maps.keys()});
    Object.defineProperty(this, 'values', {'get': () => maps.values()});
     ...
     * @returns {any}
     */
    this.get = (property) => maps.get(property);
    this.has = (property) => maps.has(property);
