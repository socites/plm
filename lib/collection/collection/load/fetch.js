function CollectionFetch(base, items, registry) {
    ...
    Object.defineProperty(base, 'fetched', {'get': () => !!fetched});

    let pagesCount = 0;
    Object.defineProperty(base, 'pagesCount', {'get': () => pagesCount});

    let next;
    Object.defineProperty(base, 'next', {'get': () => next});
    Object.defineProperty(base, 'more', {'get': () => !!next});

    let promise;

    function onResponse(response, update) {
    ...
    base.fetch = function (limit, session, update, batcher) {
        ...
        if (batcher) {
            ...
            promise.then((response) => onResponse(response, update))
                .catch(onError);
            ...
            action.onResponse = (response) => onResponse(response, update);
