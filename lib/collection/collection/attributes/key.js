function AttributesKey(map) {
    ...
    this.generate = function (except) {
        ...
        [...map.keys()].sort().forEach(function (name) {
            ...
            // If the value of the attribute is an item, take its internalId, because the id may not be set
            // when the item is recently created.
            attribute = (typeof attribute === 'object') ? attribute.internalId : attribute;
